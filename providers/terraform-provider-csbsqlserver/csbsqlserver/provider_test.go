...
var _ = Describe("Provider Configuration", func() {
	...
	DescribeTable(
		...
		Entry("database", func() { database = "" }, `invalid value "" for server identifier "database"`),
		Entry("provider username", func() { providerUsername = "" }, `invalid value "" for server identifier "username"`),
		Entry("provider password", func() { providerPassword = "" }, `invalid server password value for "password"`),
