...
variable "logs_slow_log_enabled" { type = bool }
variable "logs_slow_log_loggroup_retention_in_days" { type = number }
variable "logs_slow_log_loggroup_kms_key_id" { type = string }
